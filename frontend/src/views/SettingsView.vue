    ...
    <section class="accounts-section">
      ...
      <div class="add-account-section">
        ...
        <div class="add-buttons">
          <button class="btn connect-btn google" @click="connectGoogle">
          ...
          <button class="btn connect-btn o365" @click="connectO365">
          ...
          <button class="btn connect-btn todoist" @click="connectTodoist">
