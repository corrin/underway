...
@pytest.mark.e2e
def test_calendar_page_loads(frontend_server: str, authenticated_page: Page) -> None:
    """Calendar page loads with heading."""
    authenticated_page.goto(f"{frontend_server}/calendar")
...
@pytest.mark.e2e
def test_calendar_shows_connect_buttons(frontend_server: str, authenticated_page: Page) -> None:
...
@pytest.mark.e2e
def test_calendar_shows_events_section(frontend_server: str, authenticated_page: Page) -> None:
